...
export default class App extends Component {
  constructor(props) {
    super(props);
    {/*first I create an empty array to populate it with data to put on the page upon first load
    this avoids an error when the page tries to display data that does not exist */}
  ...
  componentDidMount() {
    fetch("http://newsapi.org/v2/top-headlines?country=us&apiKey="+env.key)
      ...
      .then(
        result => {
          {/*I call the news api and see what info I can get from it */}
          console.log(result);
          ...
          {/*create a new array that will replace the empty one I made in the constructor */}
          let newsArray=[];
          let newNewsObject;
          {/*populate the array with the api data */}
          for(let i =0;i<14;i++){
            newNewsObject = {
    ...
    return (
      <div id="grid">
        ...
        <div id="navOne">
          ...
          <h3>Support our journalism with a year-end gift</h3>
          <div className="row">
          <button>
            Contribute
        ...
        <div id="logoSection">
          {/*For some reason, putting the svg into a row, makes it disappear so I left it as it was*/}
        ...
        <div id="mainArticle">
          <div className="row">
            ...
            <img src ={this.state.data[0].urlToImage} width="75%"/>
          </div>
          <div className="row">
            <ul id="underPic">
        ...
        <div className="Article">
          ...
          <p>{this.state.data[2].title}
          <br />
          <br />
          <br />
          {this.state.data[2].description}</p>
        </div>
        <div className="nopicArticle">
          {/*Yes, I know the naming was wrong here, I had to restructure things late into the project */}
